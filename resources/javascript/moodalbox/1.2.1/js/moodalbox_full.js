...
var _CONTENTS_WIDTH 		= 550;		// Actual width of the box (px)
var _CONTENTS_HEIGHT		= 500;		// Actual height of the box (px)
var _DEF_CONTENTS_WIDTH		= 550;		// Default width of the box (px) - used for resetting when a different setting was used
