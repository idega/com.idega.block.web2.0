...
function tb_show(caption, url, imageGroup, onCloseCallback) {//function called when the user clicks on a thickbox link
	...
	try {
		if (typeof document.body.style.maxHeight === "undefined") {//if IE 6
			...
			if (document.getElementById("TB_HideSelect") === null) {//iframe to hide select elements in ie6
				...
				jQuery("#TB_overlay").click(function() {tb_remove(onCloseCallback);});
			}
		}else{//all others
	   ...
	   var urlType = baseURL.toLowerCase().match(urlString);
		...
		if(urlType == '.jpg' || urlType == '.jpeg' || urlType == '.png' || urlType == '.gif' || urlType == '.bmp'){//code to show images
			...
			jQuery("#TB_closeWindowButton").click(function() {tb_remove(onCloseCallback);});
			...
			jQuery("#TB_ImageOff").click(function() {tb_remove(onCloseCallback);});
