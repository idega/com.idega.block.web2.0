...
;(function(jQuery) {
	...
	Gritter = {
	    ...
	    add: function(user, text, image, sticky, time_alive, callback) {
	        ...
	        jQuery('#gritter-notice-wrapper').append(tmp);
	    ...
	    fade: function(e){
	        ...
	        jQuery(e).animate({
	            ...
	            jQuery(e).animate({ height: 0 }, 300, function(){
	                jQuery(e).remove();
	    ...
	    hoveringItem: function(e){
			...
			if(jQuery(e).find('img').length){
				jQuery(e).find('img').before(this._tpl_close);
			}
			else {
				jQuery(e).find('span').before(this._tpl_close);
			}
			jQuery(e).find('.gritter-close').click(function(){
				Gritter.remove(this);
			});
	    ...
	    remove: function(e){
	        ...
	        jQuery(e).parents('.gritter-item-wrapper').fadeOut('medium', function(){ jQuery(this).remove();  });
		...
		stop: function(){
			...
			jQuery('#gritter-notice-wrapper').fadeOut(function(){
				jQuery(this).remove();
			});
	    ...
	    unhoveringItem: function(e){
	        ...
	        jQuery(e).find('.gritter-close').remove();
	...
	jQuery.gritter.removeAll = function(){
		Gritter.stop();
	}
