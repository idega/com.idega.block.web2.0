...
(function ($) {
    ...
    var TeamBlock = (function () {
        function TeamBlock(source, name, order, seed, score) {
            this.source = source;
            this.name = name;
            this.order = order;
            this.seed = seed;
    ...
    function defaultRender(container, team, score, state, bracketData) {
        switch (state) {
            case 'empty-bye':
    ...
    var Round = (function () {
        function Round(bracket, previousRound, roundNumber, _results, doRenderCb, mkMatch, isFirstBracket, opts) {
    ...
    function teamElement(roundNumber, match, team, opponent, isReady, isFirstBracket, opts, resultId, topCon, renderAll, matchUserData) {
        ...
        opts.decorator.render(nEl, team.name.toNull(), scoreString, entryState, matchUserData);
    ...
    var Match = (function () {
        function Match(round, match, seed, results, renderCb, isFirstBracket, opts, resultId, topCon, renderAll) {
            ...
            var userData = this.matchUserData;
        ...
        Match.prototype.render = function () {
            ...
            this.teamCon.append(teamElement(this.round.roundNumber, this.match, this.match.a, this.match.b, isReady, this.isFirstBracket, this.opts, this.resultId, this.topCon, this.renderAll, this.matchUserData));
            this.teamCon.append(teamElement(this.round.roundNumber, this.match, this.match.b, this.match.a, isReady, this.isFirstBracket, this.opts, this.resultId, this.topCon, this.renderAll, this.matchUserData));
