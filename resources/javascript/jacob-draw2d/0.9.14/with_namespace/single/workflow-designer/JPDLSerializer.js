...
draw2d.XMLSerializer_01.prototype.toXML=function(/*:Document*/ document)
{
  ...
  for(var i=0;i< lines.getSize(); i++)
  {
    ...
    xml = xml +'<transition startX="'+line.startX+'" startY="'+line.startY+'" endX="'+line.endX+'" endY="'+line.endY+'" id="'+line.id+'" from="'+line.sourcePort.parentNode.id+'" to="'+line.targetPort.parentNode.id+'" >\n';
   
    xml = xml +'</transition>\n';
  }
  
   xml = xml + '</process-definition>';
