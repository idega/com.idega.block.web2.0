...
OverviewWindow=function(/*:String*/ name)
{
 ...
 *
 **/ 
OverviewWindow.prototype.setDimension=function(/*:int*/ w,/*:int*/ h)
{
...
OverviewWindow.prototype.addServer=function(/*:Server */ server)
{
...
OverviewWindow.prototype.removeServer=function(/*:Server */ server)
{
...
OverviewWindow.prototype.createList=function()
{
  ...
  for(key in this.servers)
  {
    ...
    if(server!=null)
    {
      ...
      a.href = "javascript:OverviewWindow.scrollTo('"+server.id+"')";
 ...
 */
OverviewWindow.scrollTo= function(/*: String */ id)
{
  var server =workflow.getFigure(id);
  workflow.scrollTo(server.getX()-OverviewWindow.screenWidth()/2,server.getY()-OverviewWindow.screenHeight()/2);
}
