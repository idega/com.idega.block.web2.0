 ...
 * @constructor
 */
ToolGeneric=function(/*:PaletteWindow*/ palette)
{
  /** @private **/
  this.x   = 0;
  /** @private **/
 ...
 *
 **/
ToolGeneric.prototype.execute=function(/*:int*/ x, /*:int*/ y)
{
  if(this.enabled)
    this.palette.setActiveTool(null);
}

ToolGeneric.prototype.setTooltip=function(/*:String*/ tooltipText)
{
 ...
 * @private
 **/
ToolGeneric.prototype.setActive=function( /*:boolean*/ flag)
{
  if(!this.enabled)
    return;
  if(flag==true)
 ...
 * @private
 **/
ToolGeneric.prototype.setEnabled=function(/*:boolean*/flag)
{
  this.enabled=flag;
  if(this.getImageUrl()!=null)
 ...
 *
 **/
ToolGeneric.prototype.setDimension=function(/*:int*/ w,/*:int*/ h)
{
  this.width = w;
  this.height= h;
 ...
 *
 **/
ToolGeneric.prototype.setPosition=function(xPos /*int*/, yPos /*int*/)
{
