 ...
 **/
Label.prototype.setFontSize= function(/*:int*/ size)
{
  this.fontSize = size;
 ...
 **/
Label.prototype.setText=function(/*:String*/ text )
{
  this.msg = text;
 ...
 **/
Label.prototype.setStyledText=function(/*:String*/ text)
{
  this.msg = text;
  this.html.removeChild(this.textNode);
