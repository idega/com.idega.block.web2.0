 ...
 */
Event.prototype.initEvent = function (sType /*: String */,
                                       bCancelable /*: boolean */) {
    this.type = sType;
 ...
 **/
Event.fireDOMEvent = function(eventType, element)
{
 ...
 */
EventTarget.prototype.addEventListener = function (sType /*: String */,
                                                    fnListener /*: Function */) {
 ...
 */
EventTarget.prototype.dispatchEvent = function (oEvent /*: Event */) /*: boolean */ {
 ...
 */
EventTarget.prototype.removeEventListener = function (sType /*: String */,
                                                       fnListener /*: Function */) {
    if (typeof this.eventhandlers[sType] != "undefined") {
