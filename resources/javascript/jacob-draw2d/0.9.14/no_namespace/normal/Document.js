 ...
 * @constructor
 */
Document=function(/*:Canvas*/ canvas)
{
  /* @private */
  this.canvas = canvas;
}
...
Document.prototype.getFigures=function()
{
  ...
  for(var i=0;i<figures.getSize();i++)
  {
    ...
    if(dialogs.indexOf(figure)==-1 && figure.getParent()==null && !(figure instanceof Window))
    {
        result.add(figure);
    }
  }
 ...
 * @type Figure
 **/
Document.prototype.getFigure=function(/*:String*/ id)
{
