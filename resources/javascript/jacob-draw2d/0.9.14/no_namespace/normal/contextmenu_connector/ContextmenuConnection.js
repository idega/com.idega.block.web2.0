...
ContextmenuConnection.prototype.getContextMenu=function()
{
  ...
  menu.appendMenuItem(new MenuItem("Blue", null,function(){oThis.setColor(new  Color(0,0,255));}));
  menu.appendMenuItem(new MenuItem("Green", null,function(){oThis.setColor(new  Color(0,255,0));}));
  menu.appendMenuItem(new MenuItem("Silver", null,function(){oThis.setColor(new  Color(128,128,128));}));
