 ...
 * @constructor
 */
Canvas=function(/*:String*/ canvasId)
{
  if(canvasId)
 ...
 *
 **/
Canvas.prototype.setViewPort= function( /*:String*/ divId)
{
 ...
 **/
Canvas.prototype.addFigure= function( /*:Figure*/figure,/*:int*/ xPos,/*:int*/ yPos, /*:boolean*/ avoidPaint)
{
 ...
 **/
Canvas.prototype.setEnableSmoothFigureHandling=function(/*:boolean*/ flag)
{
