...
ToolLine=function(palette /*:PaletteWindow*/)
{
...
ToolLine.prototype.execute=function(x /*:int*/, y/*:int*/)
{
  var figure= new Line();
  figure.setStartPoint(x,y);
  figure.setEndPoint(x+100,y+100);
  // 1.) Undo/Redo support
  this.palette.workflow.getCommandStack().execute(new CommandAdd(this.palette.workflow,figure));
