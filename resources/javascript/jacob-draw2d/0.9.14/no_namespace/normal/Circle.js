 ...
 * 
 * @see VectorFigure#setDimension
 * @param {int} w The new width of the circle.
 * @param {int} h The new height of the circle.
 **/
Circle.prototype.setDimension=function(/*:int*/ w, /*:int*/ h)
{
  if(w>h)
 ...
 *
 * @returns Returns always false. It is not possible to strech a circle. Use {@link Oval} instead.
 * @type boolean
 */
