 ...
 * @constructor
 */
Graphics=function(/*:jsGraphics*/ jsGraphics, /*:float*/ rotation, /*:Point*/translation)
{
...
Graphics.prototype.setStroke=function(/*:int*/ x)
{
   this.jsGraphics.setStroke(x);
}

Graphics.prototype.drawLine=function(/*:int*/ x1, /*:int*/ y1, /*:int*/ x2, /*:int*/ y2)
{
...
Graphics.prototype.fillRect=function(/*:int*/ x, /*:int*/ y, /*:int*/ w, /*:int*/ h)
{
   /*
        x1/y1              x2/y2
             +-----------+
...
Graphics.prototype.fillPolygon=function(/*:int[]*/ xArray, /*:int[]*/ yArray)
{
  var rotX = new Array();
  var rotY = new Array();
...
Graphics.prototype.setColor=function(/*:Color*/ color)
{
...
Graphics.prototype.drawPolygon=function(/*:int[]*/ xArray, /*:int[]*/ yArray)
{
  var rotX = new Array();
  var rotY = new Array();
