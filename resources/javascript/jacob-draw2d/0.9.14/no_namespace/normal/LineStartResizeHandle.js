 ...
 * @author Andreas Herz
 * @constructor
 * @param {Workflow} workflow The host canvas for this resize handle
 * @private
 * @final
 */
LineStartResizeHandle=function(/*:Workflow*/ workflow)
{
  Rectangle.call(this);
 ...
 * @type boolean
 **/
LineStartResizeHandle.prototype.onDragstart = function(/*:int*/ x, /*:int*/ y)
{
  // This happens if the selected figure has set the "nonResizeable" flag
 ...
 * @private
 **/
LineStartResizeHandle.prototype.onDrop = function(/*: Port*/ dropTarget)
{
  var line = this.workflow.currentSelection;
  line.isMoving=false;
 ...
 * @private
 **/
LineStartResizeHandle.prototype.onKeyDown=function(/*:int*/ keyCode , /*:boolean*/ ctrl)
{
