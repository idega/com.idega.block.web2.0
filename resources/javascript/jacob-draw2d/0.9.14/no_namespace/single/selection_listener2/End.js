...
End.prototype.setWorkflow=function(_3e54){
ImageFigure.prototype.setWorkflow.call(this,_3e54);
if(_3e54!=null&&this.inputPort==null){
this.inputPort1=new InputPort();
this.inputPort1.setWorkflow(_3e54);
...
this.inputPort2.setWorkflow(_3e54);
...
this.inputPort3.setWorkflow(_3e54);
...
this.inputPort4.setWorkflow(_3e54);
