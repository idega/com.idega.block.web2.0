...
End.prototype.setWorkflow=function(_2e52){
ImageFigure.prototype.setWorkflow.call(this,_2e52);
if(_2e52!=null&&this.inputPort==null){
this.inputPort=new MyInputPort();
this.inputPort.setWorkflow(_2e52);
...
this.inputPort2.setWorkflow(_2e52);
...
this.inputPort3.setWorkflow(_2e52);
...
this.inputPort4.setWorkflow(_2e52);
