...
ResizeImage.prototype.setWorkflow=function(_39ea){
Node.prototype.setWorkflow.call(this,_39ea);
if(_39ea!=null&&this.outputPort1==null){
this.outputPort1=new OutputPort();
this.outputPort1.setMaxFanOut(1);
this.outputPort1.setWorkflow(_39ea);
...
this.outputPort2.setWorkflow(_39ea);
