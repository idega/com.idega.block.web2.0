...
Start.prototype.setWorkflow=function(_3a35){
ImageFigure.prototype.setWorkflow.call(this,_3a35);
if(_3a35!=null&&this.outputPort==null){
this.outputPort=new MyOutputPort();
this.outputPort.setWorkflow(_3a35);
...
this.outputPort1.setWorkflow(_3a35);
...
this.outputPort2.setWorkflow(_3a35);
...
this.outputPort3.setWorkflow(_3a35);
