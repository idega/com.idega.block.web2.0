...
RoundCornerFigure.prototype.setContent=function(_3e42){
this.textarea.innerHTML=_3e42;
};
RoundCornerFigure.prototype.onDragstart=function(x,y){
var _3e45=Node.prototype.onDragstart.call(this,x,y);
if(this.header==null){
return false;
}
...
RoundCornerFigure.prototype.setWorkflow=function(_3e47){
Node.prototype.setWorkflow.call(this,_3e47);
if(_3e47!=null&&this.inputPort==null){
this.inputPort=new InputPort();
this.inputPort.setWorkflow(_3e47);
this.inputPort.setName("input");
this.addPort(this.inputPort,-5,this.height/2);
this.outputPort=new OutputPort();
this.outputPort.setMaxFanOut(5);
this.outputPort.setWorkflow(_3e47);
